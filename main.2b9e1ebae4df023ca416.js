!(function (e) {
      ...
      e.exports = (function () {
            ...
            return (
              ...
              (function (e, t, n) {
                ...
                return (
                  ...
                  v(n) &&
                    ((c = !!n.leading),
                    (a = (g = "maxWait" in n) ? h(m(n.maxWait) || 0, t) : a),
        ...
        var A = function (e, t, i) {
            ...
            return (
              ...
              _(i) &&
                ((u = !!i.leading),
                (r = (c = "maxWait" in i) ? O(L(i.maxWait) || 0, t) : r),
              ...
              I(e, [
                {
                  ...
                  value: function () {
                    var e = q();
                    return !(!G.test(e) && !R.test(e.substr(0, 4)));
                  },
                },
                {
                  key: "mobile",
                  value: function () {
                    var e = q();
                    return !(!F.test(e) && !H.test(e.substr(0, 4)));
                  },
                },
                {
                  key: "tablet",
    ...
    e.exports = (function () {
      ...
      const d = (e, t, i) => {
        if (
          ...
          throw (Object.assign(i, { el: e, expression: t }), i);
      };
      ...
      function f(e, t, i) {
        ...
        if (s) {
          ...
          n = n.concat(
            Object.entries(i).map(([e, t]) => v({ name: e, value: t }))
          );
        }
        return i
          ? n.filter((e) => e.type === i)
        ...
        if (a && a.modifiers.includes("transition")) {
          ...
          r.some((e) => ["enter", "enter-start", "enter-end"].includes(e.value))
            ? (function (e, t, i, n, s) {
                const r = g(
                    E(
                      (i.find((e) => "enter" === e.value) || { expression: "" })
                        .expression,
                      e,
                      t
                    )
      ...
      function b(e, t, i, n, s = !1) {
        ...
        if (a && a.modifiers.includes("transition")) {
          ...
          (n = s ? n.filter((e, t) => t > n.indexOf("out")) : n),
            (function (e, t, i, n, s) {
              const r = {
                duration: i ? w(t, "duration", 150) : w(t, "duration", 150) / 2,
                origin: w(t, "origin", "center"),
          ...
          r.some((e) => ["leave", "leave-start", "leave-end"].includes(e.value))
            ? (function (e, t, i, n, s) {
                const r = g(
                    E(
                      (i.find((e) => "leave" === e.value) || { expression: "" })
                        .expression,
                      e,
                      t
                    )
          ...
          p = {
            start() {
              c && (e.style.opacity = r.first.opacity),
                h && (e.style.transform = `scale(${r.first.scale / 100})`);
            },
            during() {
            ...
            show() {
              ...
              c && (e.style.opacity = r.second.opacity),
                h && (e.style.transform = `scale(${r.second.scale / 100})`);
            },
            hide() {
              n();
            },
      ...
      const E = (e, t, i) =>
        "function" == typeof e ? i.evaluateReturnExpression(t, e) : e;
      ...
      function O(e, t, n, s, r) {
        ...
        let o = P(
          ...
          l = (function (e, t, i, n) {
            ...
            return (
              C(r) && r >= 0 && (r = Array.from(Array(r).keys(), (e) => e + 1)),
              r
            );
          })(e, t, o, r),
          d = t;
        l.forEach((n, a) => {
          let u = (function (e, t, n, s, r) {
            ...
            c = (function (e, t, i, n) {
              ...
              return s
                ? e.evaluateReturnExpression(t, s.expression, () => n)
                : i;
            })(e, t, a, u),
            h = (function (e, t) {
              if (!e) return;
              ...
              for (; i; ) {
                if (i.__x_for_key === t)
                  return i.parentElement.insertBefore(i, e);
                i =
                  !(
                    !i.nextElementSibling ||
                    void 0 === i.nextElementSibling.__x_for_key
                  ) && i.nextElementSibling;
              }
      ...
      function P(e) {
        ...
        return (
          r
            ? ((n.item = s.replace(t, "").trim()),
              (n.index = r[1].trim()),
              r[2] && (n.collection = r[2].trim()))
            : (n.item = s),
          n
        );
      }
      function M(e, t, i, s, a, l, d) {
        var u = e.evaluateReturnExpression(t, s, a);
        if ("value" === i) {
          if (
            ve.ignoreFocusedForValueBinding &&
            document.activeElement.isSameNode(t)
          )
            return;
          if (
            (void 0 === u && String(s).match(/\./) && (u = ""),
            "radio" === t.type)
          )
            void 0 === t.attributes.value && "bind" === l
              ? (t.value = u)
              : "bind" !== l && (t.checked = r(t.value, u));
          else if ("checkbox" === t.type)
            "boolean" == typeof u || [null, void 0].includes(u) || "bind" !== l
              ? "bind" !== l &&
                (Array.isArray(u)
                  ? (t.checked = u.some((e) => r(e, t.value)))
                  : (t.checked = !!u))
              : (t.value = String(u));
          ...
          if (Array.isArray(u)) {
            ...
            Object.keys(u)
              ...
              .forEach((e) => {
                u[e]
                  ? g(e).forEach((e) => t.classList.add(e))
                  : g(e).forEach((e) => t.classList.remove(e));
              });
          else {
            const e = t.__x_original_classes || [],
              i = u ? g(u) : [];
            ...
            ? ((u = document),
              (d = (o) => {
                t.contains(o.target) ||
                  ...
                  (A(e, s, o, r),
                  n.includes("once") && document.removeEventListener(i, d, a));
              }))
            : ((u = n.includes("window")
                ? window
                : n.includes("document")
                  ...
                  ? ((function (e) {
                      ...
                      (function (e, t) {
                        ...
                        if (i.includes("debounce")) {
                          ...
                          i.splice(
                            e,
                            C((i[e + 1] || "invalid-wait").split("ms")[0])
                              ? 2
                              : 1
                          );
                        }
                    ...
                    A(e, s, o, r).then((e) => {
                      !1 === e
                        ? o.preventDefault()
                        : n.includes("once") && u.removeEventListener(i, d, a);
                    })
      ...
      class ne {
        ...
        getOwnPropertyDescriptor(e, t) {
          ...
          const a = F(e, t);
          return K(a)
            ? ((r = he(n, r, te)), r.configurable || B(e, t, r), r)
            : a;
        }
        preventExtensions(e) {
      ...
      class re {
        ...
        getOwnPropertyDescriptor(e, t) {
          ...
          return K(a)
            ? ((r = he(n, r, se)),
              W.call(r, "set") && (r.set = void 0),
              r.configurable || B(e, t, r),
              r)
            : a;
        }
        preventExtensions(e) {
      ...
      class pe {
        constructor(e) {
          if (
            ...
            (this.valueMutated = ue),
            (this.valueObserved = de),
            (this.valueIsObservable = le),
            ...
            (this.valueDistortion = Z(t) ? t : ce),
              (this.valueMutated = Z(i) ? i : ue),
              (this.valueObserved = Z(n) ? n : de),
              (this.valueIsObservable = Z(s) ? s : le);
          }
        }
        getProxy(e) {
          const t = ee(e),
      ...
      class fe {
        constructor(e, t = null) {
          ...
          let { membrane: o, data: l } = this.wrapDataInObservable(
            this.unobservedData
          );
          var d;
          (this.$data = l),
            ...
            s &&
              ...
              (d = this.evaluateReturnExpression(this.$el, s)),
        ...
        initializeElements(e, t = () => {}, i = !1) {
          this.walkAndSkipNestedComponents(
            ...
            (e) =>
              ...
              void this.initializeElement(e, t, !i),
            (e) => {
              i || (e.__x = new fe(e));
            }
          ),
        ...
        initializeElement(e, t, i = !0) {
          e.hasAttribute("class") &&
            f(e, this).length > 0 &&
            (e.__x_original_classes = g(e.getAttribute("class"))),
            i && this.registerListeners(e, t),
        ...
        registerListeners(e, t) {
          f(e, this).forEach(
            ({ type: n, value: s, modifiers: r, expression: a }) => {
              switch (n) {
                case "on":
                  L(this, e, s, r, a, t);
                  break;
                case "model":
                  !(function (e, t, n, s, r) {
                    ...
                    L(
                      ...
                      a,
                      n,
                      `${s} = rightSideOfExpression($event, ${s})`,
                      () =>
                        i(i({}, r()), {}, { rightSideOfExpression: D(t, n, s) })
                    );
                  })(this, e, r, a, t);
              }
            }
        ...
        resolveBoundAttributes(e, t = !1, i) {
          ...
          n.forEach(({ type: s, value: r, modifiers: o, expression: l }) => {
            switch (s) {
              case "model":
                M(this, e, "value", l, i, s, o);
                break;
              case "bind":
                if ("template" === e.tagName.toLowerCase() && "key" === r)
                  return;
                M(this, e, r, l, i, s, o);
                break;
              case "text":
        ...
        evaluateReturnExpression(e, t, n = () => {}) {
          return c(
            ...
            t,
            this.$data,
            i(i({}, n()), {}, { $dispatch: this.getDispatchFunction(e) })
          );
        }
            ...
            return u(
              () => {
                if ("function" == typeof t)
                  return Promise.resolve(t.call(i, n.$event));
                let e = Function;
                if (
                  ...
                  return "function" == typeof e
                    ? Promise.resolve(e.call(i, n.$event))
                    : Promise.resolve();
                }
  ...
  function (e, t, i) {
    ...
    function b(e, t) {
      ...
      if ("string" == typeof e) {
        ...
        if (r.indexOf("<") >= 0 && r.indexOf(">") >= 0) {
          ...
          o.innerHTML = r;
          for (var d = 0; d < o.childNodes.length; d += 1)
            s.push(o.childNodes[d]);
        } else
          s = (function (e, t) {
      ...
      return function () {
        ...
        if (void 0 === i[0]) {
          for (var s = 0; s < this.length; s += 1)
            w.indexOf(e) < 0 &&
              (e in this[s] ? this[s][e]() : b(this[s]).trigger(e));
          return this;
        }
    ...
    var E = {
        ...
        function o(e) {
          ...
          if (t) {
            ...
            if ((i.indexOf(e) < 0 && i.unshift(e), b(t).is(s))) r.apply(t, i);
              ...
              for (var n = b(t).parents(), a = 0; a < n.length; a += 1)
                b(n[a]).is(s) && r.apply(n[a], i);
          }
        }
        function l(e) {
      ...
      trigger: function () {
        for (
          var e = u(), t = arguments.length, i = new Array(t), n = 0;
          n < t;
          n++
        )
          i[n] = arguments[n];
            ...
            void 0 !== l &&
              ...
              (_(e[o]) && _(n[o])
                ? n[o].__swiper__
                  ...
                  : L(e[o], n[o])
                : !_(e[o]) && _(n[o])
                ? ((e[o] = {}), n[o].__swiper__ ? (e[o] = n[o]) : L(e[o], n[o]))
                : (e[o] = n[o]));
          }
      }
      return e;
              ...
              if (!n.isTouched || !n.isMoved)
                if (
                  ...
                  if (
                    ...
                    var f = !0;
                    o.is(n.formElements) && (f = !1),
                      t.activeElement &&
                        k(t.activeElement).is(n.formElements) &&
                        t.activeElement !== o[0] &&
        ...
        if (!i.isTouchEvent || "touchmove" === a.type) {
          ...
          if (!this.allowTouchMove)
            return (
              ...
              void (
                i.isTouched &&
                (L(s, { startX: d, startY: u, currentX: d, currentY: u }),
                (i.touchStartTime = P()))
              )
            );
    ...
    function F(e) {
      ...
      if (
        ...
        if (n.freeMode) {
            ...
            if (i.velocities.length > 1) {
              ...
              (t.velocity = v / m),
                ...
                Math.abs(t.velocity) < n.freeModeMinimumVelocity &&
                  (t.velocity = 0),
                (m > 150 || P() - p.time > 300) && (t.velocity = 0);
            } else t.velocity = 0;
          ...
          for (
            var _ = 0, L = t.slidesSizesGrid[0], A = 0;
            A < o.length;
            A += A < n.slidesPerGroupSkip ? 1 : n.slidesPerGroup
          ) {
            var z = A < n.slidesPerGroupSkip - 1 ? 1 : n.slidesPerGroup;
            void 0 !== o[A + z]
              ? u >= o[A] && u < o[A + z] && ((_ = A), (L = o[A + z] - o[A]))
              : u >= o[A] && ((_ = A), (L = o[o.length - 1] - o[o.length - 2]));
          }
          var D = (u - o[_]) / L,
          ...
          if (h > n.longSwipesMs) {
            ...
            "next" === t.swipeDirection &&
              (D >= n.longSwipesRatio ? t.slideTo(_ + j) : t.slideTo(_)),
              "prev" === t.swipeDirection &&
                (D > 1 - n.longSwipesRatio ? t.slideTo(_ + j) : t.slideTo(_));
          } else {
            ...
            (d.target === t.navigation.nextEl ||
              ...
              ? d.target === t.navigation.nextEl
                ? t.slideTo(_ + j)
                : t.slideTo(_)
              : ("next" === t.swipeDirection && t.slideTo(_ + j),
    ...
    var K = {
        ...
        update: {
            ...
            if (void 0 !== r) {
              ...
              for (
                var C,
                  ...
                  P = n.slidesPerColumn,
                  M = T / P,
                  _ = Math.floor(c / n.slidesPerColumn),
                  A = 0;
                A < c;
                A += 1
              ) {
                ...
                if (n.slidesPerColumn > 1) {
                  ...
                  if ("row" === n.slidesPerColumnFill && n.slidesPerGroup > 1) {
                    var $ = Math.floor(
                      ...
                      I = A - n.slidesPerColumn * n.slidesPerGroup * $,
                      B =
                        0 === $
                          ? n.slidesPerGroup
                          : Math.min(
                              Math.ceil((c - $ * P * n.slidesPerGroup) / P),
                              n.slidesPerGroup
                            );
                    (D =
                      (j =
                    ...
                    "column" === n.slidesPerColumnFill
                      ? ((N = A - (j = Math.floor(A / P)) * P),
                        (j > _ || (j === _ && N === P - 1)) &&
                          (N += 1) >= P &&
                          ((N = 0), (j += 1)))
                      : (j = A - (N = Math.floor(A / M)) * M);
                  z.css(
                    t("margin-top"),
                ...
                if (
                  ...
                  for (var Z = 0; Z < h.length; Z += 1) {
                    ...
                    n.roundLengths && (J = Math.floor(J)),
                      h[Z] < e.virtualSize + h[0] && C.push(J);
                  }
                  h = C;
                }
              if (!n.centeredSlides) {
          ...
          updateProgress: function (e) {
            ...
            0 === n
              ...
              L(this, { progress: s, isBeginning: r, isEnd: a }),
          ...
          loopCreate: function () {
            ...
            if (i.loopFillGroupWithBlank) {
              ...
              if (r !== i.slidesPerGroup) {
                for (var a = 0; a < r; a += 1) {
                  var o = k(t.createElement("div")).addClass(
            ...
            for (var c = 0; c < u.length; c += 1)
              n.append(k(u[c].cloneNode(!0)).addClass(i.slideDuplicateClass));
            for (var h = d.length - 1; h >= 0; h -= 1)
              n.prepend(k(d[h].cloneNode(!0)).addClass(i.slideDuplicateClass));
          },
          loopFix: function () {
            ...
            if (!a.touch && a.pointerEvents)
              ...
              if (a.touch) {
                ...
                n.addEventListener(i.start, this.onTouchStart, d),
                  ...
                  W || (e.addEventListener("touchstart", Y), (W = !0));
              }
            ...
            if (!a.touch && a.pointerEvents)
              ...
              if (a.touch) {
                ...
                n.removeEventListener(i.start, this.onTouchStart, d),
                  ...
                  i.cancel &&
                    n.removeEventListener(i.cancel, this.onTouchEnd, d);
              }
              ((t.simulateTouch && !r.ios && !r.android) ||
                (t.simulateTouch && !a.touch && r.ios)) &&
      ...
      J = (function () {
        function e() {
          ...
          (o.__swiper__ = !0),
            (o.support = z()),
            (o.device = D({ userAgent: i.userAgent })),
            (o.browser = j()),
            (o.eventsListeners = {}),
        ...
        return (
          ...
          (e.installModule = function (t) {
            ...
            var i =
              t.name || Object.keys(e.prototype.modules).length + "_" + P();
    ...
    var te = {
      ...
      ie = {
        ...
        create: function () {
          A(this, { autoplay: ee({}, te, { running: !1, paused: !1 }) });
        },
        on: {
          init: function (e) {
      ...
      ((e = null) => {
        const t = document.querySelectorAll(
          ...
          i = (i) => {
            const n = i ? "" : "none";
            t.forEach((t) => {
              (!e || "outline" === e) && t.style.setProperty("outline", n),
                (!e || "box-shadow" === e) &&
                  t.style.setProperty("box-shadow", n);
            });
          },
          n = () => {
            t.length > 0 && (i(!1), window.addEventListener("keydown", s)),
    ...
    var ae = document.querySelectorAll(".light-switch");
    ae.length > 0 &&
